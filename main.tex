...
doublespacing %onehalfspacing %singlespacing, % Single line spacing, alternatives: onehalfspacing or doublespacing
...
eee\pagestyle{thesis} % Return the page headers back to the "thesis" style
...
\include{Chapters/DesignStudy}
\include{Chapters/lens}
